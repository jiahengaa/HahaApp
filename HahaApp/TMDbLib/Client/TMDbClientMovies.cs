...
namespace TMDbLib.Client
{
    public partial class TMDbClient
    {
        ...
        public async Task<SearchContainerWithDates<SearchMovie>> GetMovieUpcomingListAsync(string language = "zh-CN", int page = 0, string region = null, CancellationToken cancellationToken = default(CancellationToken))
        {
